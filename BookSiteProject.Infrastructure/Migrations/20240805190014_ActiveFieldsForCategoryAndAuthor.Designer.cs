...
namespace BookSiteProject.Infrastructure.Migrations
{
    ...
    [Migration("20240805190014_ActiveFieldsForCategoryAndAuthor")]
    partial class ActiveFieldsForCategoryAndAuthor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookSiteProject.Domain.Entities.BookOffer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookSiteProject.Domain.Entities.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookSiteProject.Domain.Entities.Book", b =>
                {
                    ...
                    b.HasOne("BookSiteProject.Domain.Entities.Identity.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BookSiteProject.Domain.Entities.BookOffer", b =>
                {
                    b.HasOne("BookSiteProject.Domain.Entities.Book", "Book")
                        .WithMany("BookOffers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookSiteProject.Domain.Entities.Identity.ApplicationUser", null)
                        .WithMany()
